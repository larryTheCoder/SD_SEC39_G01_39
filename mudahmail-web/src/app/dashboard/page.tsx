...
export default function Home() {
    ...
    return (
        <>
            ...
            {session ?
                dashboard === "dashboard" ? (<>
                        <div className="justify-between items-center mx-auto max-w-8xl p-4 pt-16 md:pr-16 md:pl-16">
                    ...
                    dashboard === "profile" ? (
                        <>
                            <div className="justify-between items-center mx-auto max-w-8xl p-4 pt-16 md:pr-16 md:pl-16">
                                <div className="grid grid-cols-1 pt-6 xl:grid-cols-3 xl:gap-4 dark:bg-gray-900">
                                    <EditProfile profileUpdate={setProfilePicture}/>
                                </div>
                            </div>
                        </>
                    ) : (dashboard === "admin" ? (
                        <>
                            <div className="p-4 pt-16 md:pr-16 md:pl-16">
                                <div className="pt-6">
                                    <AdminControlPanel/>
                                </div>
                            </div>
        ...
        <>
            ...
            <div className="col-span-2">
                <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-gray-800">
                    ...
                    <div className="grid col-span-12 grid-rows-4 grid-cols-6 gap-6">
            ...
            <div className="col-span-full xl:col-auto">
                <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 sm:p-6">
                    <div className="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
                        <ProfileUpdate profilePicture={session.user?.image ?? ""} setProfilePicture={profileUpdate}/>
                    </div>
                </div>
                <div className="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 sm:p-6">
                    <ChangePassword/>
